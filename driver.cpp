...
void helpScreen(int page) {

    //variable that stores the player's decisions within the help menu
    string helpDecision;

    if(page == 1) {

        while(toUpper(helpDecision) != "NEXT" && toUpper(helpDecision) != "BACK") {
            ...
            if(toUpper(helpDecision) == "NEXT")
                helpScreen(2);
            if(toUpper(helpDecision) == "BACK")
                return;
        }
    }
    else if(page == 2) {

        while(toUpper(helpDecision) != "PREVIOUS" && toUpper(helpDecision) != "NEXT" && toUpper(helpDecision) != "BACK") {
            ...
            cout <<  "*                                                     *" << endl;
            cout <<  "*-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-*" << endl;
            cout <<  "*               = THE HAND AND DECK =                 *" << endl;
            cout <<  "*  Once the 7 main piles are dealt, the remainder of  *" << endl;
            cout <<  "*  the cards are called the deck. A pile of cards     *" << endl;
            cout <<  "*  called the hand is generated by dealing 3 cards at *" << endl;
            cout <<  "*  a time from the deck to the hand. If there are no  *" << endl;
            cout <<  "*  possible moves left within the main 7 piles, a     *" << endl;
            cout <<  "*  player can deal more cards and use the top card    *" << endl;
            cout <<  "*  from the hand to make a move. The player can deal  *" << endl;
            cout <<  "*  as many times as they want.                        *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*                 = LOSING THE GAME =                 *" << endl;
            cout <<  "*  A player loses the game once there are no more     *" << endl;
            cout <<  "*  possible moves based on the cards in the main      *" << endl;
            cout <<  "*  piles as well as the order of the cards in the     *" << endl;
            cout <<  "*  deck and hand. The game will automatically check   *" << endl;
            cout <<  "*  to see if you have any moves left, and if you do   *" << endl;
            cout <<  "*  not, it will end the game.                         *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*                                                2/3  *" << endl;
            ...
            if(toUpper(helpDecision) == "PREVIOUS")
                helpScreen(1);
            if(toUpper(helpDecision) == "NEXT")
                helpScreen(3);
            if(toUpper(helpDecision) == "BACK")
        ...
        while(toUpper(helpDecision) != "PREVIOUS" && toUpper(helpDecision) != "BACK") {
            ...
            cout <<  "*-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-*" << endl;
            cout <<  "*                     = CONTROLS =                    *" << endl;
            cout <<  "*  >Move a card to another card:         \"5S to 6D\"   *" << endl;
            cout <<  "*  >Move a King to an empty pile:        \"KH to 3\"    *" << endl;
            cout <<  "*  >Move an Ace to an empty win pile:    \"AS to S\"    *" << endl; 
            cout <<  "*  >Deal 3 cards from the deck:          \"deal\"       *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*  ->When moving a King to an empty pile, use a       *" << endl;
            cout <<  "*  number 1-7 to indicate an empty pile.              *" << endl;
            cout <<  "*  ->When moving an Ace to an empty win pile, use     *" << endl;
            cout <<  "*  the first letter of its suit.                      *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*                                                     *" << endl;
            cout <<  "*                                                     *" << endl;
...
int main() {
    ...
    */
    ...
    while(toUpper(trash) != "START")  {
        ...
        cout <<  "*                                                     *" << endl;
        cout <<  "*     -Type \"help\" at any time for the help screen-   *" << endl; 
        cout <<  "*                                                     *" << endl;
    ...
    */
    ...
    while(true) {
        ...
        if(toUpper(playerMove1) == "HELP") {
            helpScreen(1);
            goto turn;
        }

        //collects the second word of the user's move
        cin >> playerMove2;

        //allows for break from taking turns
        if(toUpper(playerMove2) == "EXIT") {
            exitScreen();
            return 0;
        }
        
        //allows for dealing without requiring 3 different words
        if(toUpper(playerMove2) == "DEAL") {
            goto turn;
        }

        //displays the help screen
        if(toUpper(playerMove2) == "HELP") {
            helpScreen(1);
            goto turn;
        }
        
        //collects the third word of the user's move
        cin >> playerMove3;

        //allows for break from taking turns
        if(toUpper(playerMove3) == "EXIT") {
            exitScreen();
            return 0;
        }
        
        //allows for dealing without requiring 3 different words
        if(toUpper(playerMove3) == "DEAL") {
            goto turn;
        }

        //displays the help screen
        if(toUpper(playerMove3) == "HELP") {
            helpScreen(1);
            goto turn;
        }
